	...
	public static void main(String[] args) {
		...
		public CommandLineRunner bookDemo(BookRepository bookRepository, CategoryRepository crepository, UserRepository urepository) { 
			return (args) -> {
				...
				User user3 = new User ("StadinMarkku", "$2a$06$3jYRJrg0ghaaypjZ/.g4SethoeA51ph3UD4kZi9oPkeMTpjKU5uo6", "USER"); // salasana user, moodlessa näkyvä encrypt sivu ei toiminut
